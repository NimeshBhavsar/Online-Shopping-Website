                ...
                <div class="card-header card-header-icon card-header-rose">
                  <div class="card-icon">
                   ...
                   <?php
                            ...
                            ?>
                  <h4 class="card-title">My Wishlist (<?php echo get_count('tbl_wishlist',$datavaluestwo,'customer_id'); ?>)
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php foreach ($wishlist as $key => $value) { 
                    ?>
                    <div class="row border_own">
                    <div class="col-md-2">
                      <img src="<?php echo base_url()."uploads/".get_value('tbl_products','product_id',$value->product_id,'pro_img1');?>" class="img_own">
                     
                        
                      <div class="stock_div_own"><span class="stock_own"><?php echo get_stock($value->product_id); ?></span></div>
                    </div>
                    <div class="col-md-9">
                      <a href="#" target="_blank" class="link_own"><?php echo get_value('tbl_products','product_id',$value->product_id,'pro_name');?></a>
                      <div class="gUuXy- _2D5lwg"><span id="productRating_LSTVESEXFZGH6NFHMZ71WROO4_VESEXFZGH6NFHMZ7_" class="_1lRcqv"><div class="_3LWZlK"><?php echo get_rating($value->product_id);?><img src="data:image/svg+xml;base64," class="_1wB99o">
                      ...
                      <div class="_3T5d8x"><img height="21" src="<?php echo base_url()?>assets/admin_assets/img/flipkart_assured.png"></div>

                    <div class="own_cost"><span class="amount_own">₹<?php echo get_value('tbl_products','product_id',$value->product_id,'pro_final_amount');?> </span><span class="discount_amount_own">₹<?php echo get_value('tbl_products','product_id',$value->product_id,'pro_amount');?></span> <span class="offer_own">₹<?php echo get_value('tbl_products','product_id',$value->product_id,'pro_off_percentage');?> off</span></div>
                    </div>
                    <div class="col-md-1">
                      <a href="<?php echo base_url()."delete_wishlist/".$value->wishlist_id; ?>" class="link_own" title="Remove from Wishlist"><i class="material-icons">delete</i></a>
                    </div>
                  </div>
                  <?php  } ?>
...
<style type="text/css">
  .border_own{border-bottom: 1px solid #e0e0e0;padding: 20px;padding-bottom: 30px;}
  .img_own{height: 100px;
    width: 100px;}
    .link_own{
    font-weight: 400;
    font-size: 15px;
...
.XXTbyN ._16qZvh ._1qGLe2 {
    font-size: 22px;
    display: inline-block;
    vertical-align: middle;
}
.XXTbyN ._16qZvh ._1eAROs {
    padding-top: 10px;
    margin-left: 10px;
}
.offer_own {
...
.amount_own{font-size: 22px;font-weight: bold;}
.own_cost{margin-top:10px ;}
.discount_amount_own{    text-decoration: line-through;
    font-size: 14px;
    color: #878787;margin-left:5px ;line-height: 10px;}
   .stock_own{
    font-size: 12px;
...
.stock_div_own{width: 100px;text-align: center;line-height: 13px;}
</style>