            ...
            <div class="col-md-5">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="<?php echo base_url()?>sub_cat_update" id="LoginValidation" enctype="multipart/form-data"> 
                  <?php }else{ ?>
                  <form method="post" action="<?php echo base_url()?>sub_cat_add" id="LoginValidation" enctype="multipart/form-data"> 
                  <?php } ?>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="cat_id" class="bmd-label-floating pull-right">Category</label>
                           <select class="form-control" required="true" name="cat_id" id="cat_id">
                              <option value=""></option>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="sub_cat_name" class="bmd-label-floating"> Sub Category Name*</label>
                          <input type="text" class="form-control name_type" required="true" name="sub_cat_name" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->sub_cat_name){ echo'value="'.$edit_fetch_data[0]->sub_cat_name.'"'; } ?> id="sub_cat_name">
                          <input type="hidden" class="form-control" required="true" name="sub_cat_id" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->sub_cat_id){ echo"value='".$edit_fetch_data[0]->sub_cat_id."'"; } ?> id="sub_cat_id">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">                   
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url()?>Admin_controller/upd_status/tbl_sub_category/sub_cat_id/<?php echo $value->sub_cat_id;?>/status/<?php echo $status_val;?>/sub_cat" class="btn btn-link btn-warning btn-just-icon edit"
                            <?php if($value->status =='YES'){ echo"title='Turn Off Sub Category'"; }else{ echo"title='Turn On Sub Category'";} ?>><i class="material-icons">dvr</i></a>
                            <a href="<?php echo base_url()?>sub_cat_edit/<?php echo $value->sub_cat_id;?>" class="btn btn-link btn-danger btn-just-icon edit"><i class="material-icons">edit</i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
