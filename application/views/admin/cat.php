            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title"><?php if(!empty($edit_fetch_data)){ echo"Edit"; }else{ echo"Add";} ?> Category
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="<?php echo base_url()?>cat_update" id="LoginValidation" enctype="multipart/form-data"> 
                  <?php }else{ ?>
                  <form method="post" action="<?php echo base_url()?>cat_add" id="LoginValidation" enctype="multipart/form-data"> 
                  <?php } ?>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control name_type" required="true" name="category_name" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->category_name){ echo'value="'.$edit_fetch_data[0]->category_name.'"'; } ?> id="category_name">
                          <input type="hidden" class="form-control" required="true" name="cat_id" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->cat_id){ echo"value='".$edit_fetch_data[0]->cat_id."'"; } ?> id="cat_id">
                        </div>
                      </div>
                      <div class="col-md-12 col-sm-4">
                          ...
                          <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                              <div class="fileinput-new thumbnail">
                                <img <?php if(!empty($edit_fetch_data) && !empty($edit_fetch_data[0]->cat_img)){ ?> src="<?php echo base_url()?>uploads/<?php echo $edit_fetch_data[0]->cat_img; ?>"<?php }else{ ?> src="<?php echo base_url()?>assets/admin_assets/img/image_placeholder.jpg" <?php } ?>>
                              </div>
                              <div class="fileinput-preview fileinput-exists thumbnail"></div>
                              <div>
                                <span class="btn btn-success btn-round btn-file">
                                  <span class="fileinput-new">Category Image</span>
                                  <span class="fileinput-exists">Change</span>
                                  <input type="file" name="cat_img" <?php if(!empty($edit_fetch_data) && !empty($edit_fetch_data[0]->cat_img)){ }else{ ?>required <?php } ?>>
                                </span>
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo base_url()?>uploads/<?php echo $value->cat_img; ?>" class="card-avatar1"></td>
                            <td><?php echo $value->status; ?></td>
                            <td class="text-right">
                              <?php if($value->status =='YES'){ $status_val="NO";}else{ $status_val="YES";} ?>
                            <a href="<?php echo base_url()?>Admin_controller/upd_status/tbl_category/cat_id/<?php echo $value->cat_id;?>/status/<?php echo $status_val;?>/cat" class="btn btn-link btn-warning btn-just-icon edit"
                            <?php if($value->status =='YES'){ echo"title='Turn Off Category'"; }else{ echo"title='Turn On Category'";} ?>><i class="material-icons">dvr</i></a>
                            <a href="<?php echo base_url()?>cat_edit/<?php echo $value->cat_id;?>" class="btn btn-link btn-danger btn-just-icon edit"><i class="material-icons">edit</i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
