            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title">Get Your Order Reports
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="<?php echo base_url()?>Admin_controller/get_rows">
                  <div class="row">
                    <div class="col-md-4">
                      <label>Start Date</label>
                      <input type="date" name="start_date"  id="sdate" class="form-control" <?php if(!empty($sdate)){ ?> value="<?php echo $sdate; ?>"<?php } else{ ?> value="<?php echo date('Y-m-d'); ?>"<?php } ?>>
                    </div>
                    <div class="col-md-4">
                      <label>End Date</label>
                      <input type="date" name="end_date" id="edate" class="form-control" <?php if(!empty($edate)){ ?> value="<?php echo $edate; ?>"<?php } else{ ?> value="<?php echo date('Y-m-d'); ?>"<?php } ?>>
                    </div>
                    <div class="col-md-4">
                      <label>Select Type</label>
                      <select class="form-control" name="type" id="order_type">
                        <option value="all" <?php if(!empty($order_type) && $order_type =='all'){ echo"selected"; } ?>>All</option>
                        <option value="SUCCESS" <?php if(!empty($order_type) && $order_type =='SUCCESS'){ echo"selected"; } ?>>SUCCESS</option>
                        <option value="PENDING" <?php if(!empty($order_type) && $order_type =='PENDING'){ echo"selected"; } ?>>PENDING</option>
                        <option value="SHIPPED" <?php if(!empty($order_type) && $order_type =='SHIPPED'){ echo"selected"; } ?>>SHIPPED</option>
                      </select>
                    </div>
                    <div class="col-md-4">
                  ...
                  <form method="post" action="<?php echo base_url()?>Admin_controller/get_rows_pdf" class="query_hidden" target="_blank">
                  <div class="row">
                      <div class="col-md-4 ">
