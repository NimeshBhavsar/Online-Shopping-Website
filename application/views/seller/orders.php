                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center">Bill Order</th>
                          <th class="text-center">Date of Received</th>
                          <th class="text-center">Feedback</th>
                          <th class="text-center">Feedback Comments</th>
                          <th class="text-center">Number of Stars</th>
                          <th class="text-center">Feedback Img I</th>
                          <th class="text-center">Feedback Img II</th>
                          <th class="text-center">Feedback Img III</th>
                        </tr>
                      </thead>
                      <tfoot>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo get_value('tbl_login','customer_id',$value->customer_id,'user_name')." - ".get_value('tbl_login','customer_id',$value->customer_id,'email_id')." - ".get_value('tbl_login','customer_id',$value->customer_id,'mobile_no'); ?></td>
                            <?php if($value->cutomer_status =='CANCEL'){echo"<td></td>"; }else{  ?>
                            <td><a href="<?php echo base_url()."down_invocie/".$value->order_id;?>" class="btn btn-success">Invoice</a></td>
                          <?php  } ?>
                            <?php if($value->seller_status =='SUCCESS' || $value->seller_status =='REJECTED'){ $a="View"; }else{ $a="Update"; } ?>
                            <?php if($this->session->userdata('role') =='admin'){ ?>
                            <td><a href="<?php echo base_url()."view_order_admin/".$value->order_id.""; ?>" class="btn btn-rose">View Order</a></td>
                          <?php }elseif($this->session->userdata('role') =='customer'){ ?>
                            <td><a href="<?php echo base_url()."view_order_customer/".$value->order_id.""; ?>" class="btn btn-rose">View Order</a></td>
                             <?php }else{ ?>
                            <td><a href="<?php echo base_url()."view_order/".$value->order_id.""; ?>" class="btn btn-rose"><?php echo $a;?> Order</a></td>
                          <?php } ?>
                            <td><?php echo $value->seller_status; ?></td>
                            <td><?php echo $value->cutomer_status; ?></td>
                            <td><?php echo $value->amount; ?></td>
                            <td><?php echo $value->offer_amount; ?></td>
                            <td><?php echo $value->quantity_in_no; ?></td>
                            <td><?php echo $value->date_of_order; ?></td>
                            <td><?php echo $value->shipped_date; ?></td>
                            <td><?php echo $value->bill_of_order; ?></td>
                            <td><?php echo $value->date_of_received; ?></td>
                            <td><?php echo $value->feedback; ?></td>
                            <td><?php echo $value->feedback_cmt; ?></td>
                            <td><?php echo $value->stars_in_number; ?></td>
                            <td><?php echo $value->feedback_img1; ?></td>
                            <td><?php echo $value->feedback_img2; ?></td>
                            <td><?php echo $value->feedback_img3; ?></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
