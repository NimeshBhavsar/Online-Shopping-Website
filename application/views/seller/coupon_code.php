            ...
            <div class="col-md-5">
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title"><?php if(!empty($edit_fetch_data)){ echo"Edit"; }else{ echo"Add";} ?> Coupon Code
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="<?php echo base_url()?>coupon_code_update" id="LoginValidation" enctype="multipart/form-data"> 
                  <?php }else{ ?>
                  <form method="post" action="<?php echo base_url()?>coupon_code_add" id="LoginValidation" enctype="multipart/form-data"> 
                  <?php } ?>
                    
                      <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="coupon_type" class="bmd-label-floating"> Coupon Code Type*</label>
                          <input type="text" class="form-control name_type" required="true" name="coupon_type" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->coupon_type){ echo'value="'.$edit_fetch_data[0]->coupon_type.'"'; } ?> id="coupon_type">
                          <input type="hidden" class="form-control" required="true" name="coupon_id" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->coupon_id){ echo"value='".$edit_fetch_data[0]->coupon_id."'"; } ?> id="coupon_id">
                        </div>
                      </div>
                      <br>
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="percentage" class="bmd-label-floating"> Percentage*</label>
                          <input type="text" class="form-control name_type" required="true" name="percentage" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->percentage){ echo'value="'.$edit_fetch_data[0]->percentage.'"'; } ?> id="percentage">
                      ...
                      <br>
                        <div class="col-md-12">
                        <div class="form-group">
                          <label for="maximum_amount" class="bmd-label-floating"> Maximum Amount*</label>
                          <input type="text" class="form-control name_type" required="true" name="maximum_amount" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->maximum_amount){ echo'value="'.$edit_fetch_data[0]->maximum_amount.'"'; } ?> id="maximum_amount">
                      ...
                      <br>
                        <div class="col-md-12">
                        <div class="form-group">
                          <label for="valid_date" class="bmd-label-floating"></label>
                          <input type="date" class="form-control name_type" required="true" name="valid_date" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->valid_date){ echo'value="'.$edit_fetch_data[0]->valid_date.'"'; } ?> id="valid_date">
            ...
            <div class="col-md-7">
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title">View All Coupon Code
                    <small class="category"></small>
                  </h4>
                  <p class="invalid_msg text-center text-white font-weight-bold bg-info"><?php echo $this->session->tempdata('success'); $this->session->unset_tempdata('success') ?></p>
                </div>
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url()?>Admin_controller/upd_status/tbl_coupon_code/coupon_id/<?php echo $value->coupon_id;?>/status/<?php echo $status_val;?>/coupon_code" class="btn btn-link btn-warning btn-just-icon edit"
                            <?php if($value->status =='YES'){ echo"title='Turn Off Coupon Code'"; }else{ echo"title='Turn On Coupon Code'";} ?>><i class="material-icons">dvr</i></a>
                            <a href="<?php echo base_url()?>coupon_code_edit/<?php echo $value->coupon_id;?>" class="btn btn-link btn-danger btn-just-icon edit"><i class="material-icons">edit</i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
