          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title">Edit Profile 
                    <small class="category text-danger"><?php if(($this->session->userdata('role') =='seller') && $login_data[0]->admin_approve_cmy == '1' ){  ?> Your Submission Will be Done admin view and approve your details -(status - Pending)  <?php }else{ if($login_data[0]->admin_approve_cmy =='' && $login_data[0]->rejection_reason !=''){ echo"<br>Status - Rejected<br>Reason - ".$login_data[0]->rejection_reason." (Re-apply your document correctly)";}else{ ?>Complete your profile with Respective Attachements <?php } } ?> </small>
                  </h4>
                ...
                <div class="card-body">
                  <form method="post" action="<?php echo base_url()?>cm_profile_update" id="LoginValidation" enctype="multipart/form-data"> 
                    <div class="row">
                      <div class="col-md-4">
                      ...
                      <div class="col-md-5">
                       ...
                       <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required="true" name="mobile_no" <?php if(!empty($login_data) && $login_data[0]->mobile_no){ echo"value='".$login_data[0]->mobile_no."'"; } ?> number="true" id="mobile_no">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                      ...
                      <div class="col-md-3">
                       ...
                       <div class="col-md-12">
                        <div class="form-group">
                          <label for="about_me" class="bmd-label-floating"> About Company</label>
                          <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-4">
                          ...
                          <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                              <div class="fileinput-new thumbnail">
                                <?php
                                  if (!empty($login_data[0]->company_logo) && strpos($login_data[0]->company_logo, '.pdf') !== false)
                                  { ?>
                                    <a href="<?php echo base_url()?>uploads/<?php echo $login_data[0]->company_logo; ?>" target="_blank" class="text-success">View Pdf document</a>

                               <?php   }else{
                                ?>
                                <img <?php if(!empty($login_data) && !empty($login_data[0]->company_logo)){ ?> src="<?php echo base_url()?>uploads/<?php echo $login_data[0]->company_logo; ?>"<?php }else{ ?> src="<?php echo base_url()?>assets/admin_assets/img/image_placeholder.jpg" <?php } ?>>
                              <?php   }
                                ?>
                              </div>
                              ...
                              <div>
                                <span class="btn btn-rose btn-round btn-file">
                                  ...
                                  <input type="file" name="company_logo" <?php if(!empty($login_data) && !empty($login_data[0]->company_logo)){ }else{ ?>required <?php } ?>>
                                </span>
                        ...
                        <div class="col-md-6 col-sm-4">
                          <h4 class="title">Company Apporvel Documents</h4>
                          <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                              <div class="fileinput-new thumbnail">
                                <?php
                                  if (!empty($login_data[0]->company_app_doct) && strpos($login_data[0]->company_app_doct, '.pdf') !== false)
                                  { ?>
                                    <a href="<?php echo base_url()?>uploads/<?php echo $login_data[0]->company_app_doct; ?>" target="_blank" class="text-success">View Pdf document</a>

                               <?php   }else{
                                ?>
                                <img <?php if(!empty($login_data) && !empty($login_data[0]->company_app_doct)){ ?> src="<?php echo base_url()?>uploads/<?php echo $login_data[0]->company_app_doct; ?>"<?php }else{ ?> src="<?php echo base_url()?>assets/admin_assets/img/image_placeholder.jpg" <?php } ?>>
                              <?php   }
                                ?>
                              </div>
                              <div class="fileinput-preview fileinput-exists thumbnail"></div>
                              <div>
                                <span class="btn btn-rose btn-round btn-file">
                                  <span class="fileinput-new">Company Documents</span>
                                  <span class="fileinput-exists">Change</span>
                                  <input type="file" name="company_app_doct" <?php if(!empty($login_data) && !empty($login_data[0]->company_app_doct)){ }else{ ?>required <?php } ?>>
                                </span>
                                <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
                              </div>
                          </div>
                        ...
                        <div class="col-md-12">
                        <div class="form-group">
                          <label for="company_details" class="bmd-label-floating"> Company Details</label>
                          <div class="form-group">
                          <label class="bmd-label-floating"> If you not interested, simply skip.</label>
                          <textarea class="form-control" rows="5" id="company_details" name="company_details" required="true"><?php if(!empty($login_data) && $login_data[0]->company_details){ echo $login_data[0]->company_details; } ?></textarea>
                        </div>
                        </div>
                      </div>
                    </div>
                    <?php if(($this->session->userdata('role') =='seller') && $login_data[0]->admin_approve_cmy != '1'){  ?>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body">
                  <h6 class="card-category text-gray">Company Owner</h6>
